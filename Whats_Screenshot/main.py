...
from interface import WhatsAppAutomationUI # Importa a interface gráfica gerada pelo Qt Designer

def main():
    app = QApplication(sys.argv) # Cria uma instância da aplicação Qt, Qt significa que é uma aplicação gráfica.
    window = WhatsAppAutomationUI() # Instancia a interface corretamente
